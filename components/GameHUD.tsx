          ...
          <div className={`pointer-events-auto relative transition-all duration-300 rounded-2xl bg-slate-950/90 backdrop-blur-xl border border-cyan-500/60 shadow-2xl overflow-hidden flex flex-col items-center ${
            ...
            <div className="relative w-full h-full flex items-center justify-center">
              ...
              <div className="relative z-10 flex items-center justify-center">
                <div className="w-3 h-3 bg-cyan-400 rounded-full border border-cyan-100 shadow-[0_0_8px_rgba(34,211,238,1)] flex items-center justify-center">
                  <div 
                    className="w-0.5 h-3 bg-cyan-200 origin-bottom" 
              ...
              {telemetry.radarBlips && telemetry.radarBlips.map((blip, idx) => {
                ...
                const colorClass = 
                  blip.type === 'police'
                    ...
                    : blip.type === 'debris'
                    ? 'bg-purple-400 shadow-[0_0_4px_rgba(192,132,252,1)]'
                    : 'bg-slate-300';
          ...
          <div className="pointer-events-auto flex flex-col items-center gap-2">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <button
                ...
                title="Requires 3 Bio-Specimens (Abduct humans to gain specimens)"
              >
